...
// Get actas and cotizaciones
$actas = $actaModel->getByPromotor($user_id);
$cotizaciones = $cotizacionModel->getByPromotor($user_id);
...
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col">
            <h2 class="h3"><i class="bi bi-clock-history me-2"></i>Mi Historial</h2>
            <p class="text-muted">Consulta tus actas de visita y cotizaciones</p>
        </div>
    </div>

    <!-- Updated tabs with new styles -->
            ...
            <?php if (empty($actas)): ?>
                <div class="card border-0 shadow-sm">
                    <div class="card-body text-center py-5">
                        ...
                        <p class="text-muted">Las actas de visita que registres aparecerán aquí</p>
                        <a href="acta_visita.php" class="btn btn-primary mt-2">
                        ...
                        <div class="col-md-6 col-lg-4 mb-3">
                            <div class="card history-card h-100 shadow-sm" onclick="verActaDetalle(<?php echo $acta['id']; ?>)">
                                <div class="card-body">
                                    ...
                                    <?php if ($acta['receptor_telefono']): ?>
                                        <p class="mb-2 small text-muted">
                                            <i class="bi bi-telephone me-1"></i>
                                            <?php echo htmlspecialchars($acta['receptor_telefono']); ?>
                                        </p>
                                    <?php endif; ?>
            ...
            <?php if (empty($cotizaciones)): ?>
                <div class="card border-0 shadow-sm">
                    <div class="card-body text-center py-5">
                        ...
                        <p class="text-muted">Las cotizaciones que generes aparecerán aquí</p>
                        <a href="cotizacion.php" class="btn btn-primary mt-2">
                            <i class="bi bi-plus-circle me-2"></i>Generar Primera Cotización
                        </a>
                    </div>
                </div>
            <?php else: ?>
                    ...
                    let html = `
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 text-md-end">
                                ...
                                <p class="mb-1 text-muted">Promotor: ${cot.promotor_nombre}</p>
